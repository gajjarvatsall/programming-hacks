...
class ListItemWrapper extends StatefulWidget {
  ...
  @override
  State<ListItemWrapper> createState() => _ListItemWrapperState();
}
...
class _ListItemWrapperState extends State<ListItemWrapper>
  ...
  void initState() {
    super.initState();
    final int perspectiveDirectionMultiplier = widget.scrollDirection == ScrollDirection.forward ? -1 : 1;

    final AlignmentGeometry directionAlignment =
        widget.scrollDirection == ScrollDirection.forward ? Alignment.bottomCenter : Alignment.topCenter;
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) => Transform(
        transform: Matrix4.identity()..setEntry(3, 1, perspectiveAnimation.value),
